...
class Note extends FlxSprite
{
	...
	public static var colArray:Array<String> = ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I','J','K'];
	public static var colArrayAlt:Array<String> = ['purple', 'blue', 'green', 'red', 'white', 'yellow', 'violet', 'black', 'dark','purple','red'];
	public static var pressArrayAlt:Array<String> = ['left', 'down', 'up', 'right', 'white', 'yellow', 'violet', 'black', 'dark','left','right'];
	public static var defaultNoteSkin(default, never):String = 'noteSkins/NOTE_assets';

	public static var scales:Array<Float> = [0.7, 0.7, 0.7, 0.7, 0.65, 0.6, 0.55, 0.5, 0.46,0.7,0.7];
	public static var scalesPixel:Array<Float> = [1, 1, 1, 1, 0.93, 0.86, 0.79, 0.71, 0.66,0.66];
	public static var splashOffsetScale:Array<Float> = [1, 1, 1, 1, 1.08, 1.17, 1.27, 1.4, 1.52,1,1];
	public static var swidths:Array<Float> = [112, 112, 112, 112, 98, 84, 77, 70, 63,66,66];
	public static var posRest:Array<Int> = [-168, -112, -56, 0, 15, 35, 45, 55, 60,75,85];
	public static var midArray:Array<Int> = [0, 0, 1, 1, 2, 2, 3, 3, 4,5,5];
	...
	public var forceHitSound:Bool = false;
		...
		if(noteData > -1 && noteType != value) {
			switch(value) {
				...
				case 'Bullet Note':
					missHealth = 0.3;
					hitsound = 'lol';
                    reloadNote('Note_bullet.png');
					// splash data and colors
					noteSplashData.r = 0xFFFFEA00;
					noteSplashData.g = 0xFF101010;
					noteSplashData.texture = 'noteSplashes/noteSplashes-electric';
					forceHitSound = true;	
			}
