...
class FunkinLua
{
	...
	public function new(scriptName:String)
	{
		...
		Lua_helper.add_callback(lua, "setColorOfObject", function(object:String, clr:FlxColor = FlxColor.RED)
		{
			var real = game.getLuaObject(object);
			if (real != null)
			{
				real.color = clr;
				return true;
			...
			luaTrace("setColorOfObject: Object " + object + " doesn't exist!", false, false, FlxColor.RED);
			return false;
		});
